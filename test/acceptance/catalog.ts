...
export const operationBranches = {
  ...
  "machine-credential.manage": ["owner.create.allowed","non-owner.create.denied","owner.revoke.allowed","revoked.next-request.denied"],
  "machine-corpus.read": ["valid.introspect.allowed","participant-contribution.allowed","project-native.allowed","outside-project.denied","retracted.next-request.denied","archived.allowed","shell.denied","malformed.denied"],
} as const;
